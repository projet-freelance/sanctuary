<div wire:key="versets-du-jour" class="bg-gradient-to-br from-blue-50 to-white min-h-[400px] p-6 rounded-2xl shadow-lg max-w-md mx-auto relative overflow-hidden">
        ...
        <div class="bg-white rounded-xl p-6 shadow-md relative z-10">
            @if(count($verses) > 0)
                <div class="text-center">
                    ...
                    <div class="mt-12">
                        <p class="text-xl font-semibold text-gray-800 mb-2" id="verseReference">
                        ...
                        <button 
                            onclick="speakVerse()"
                            class="bg-green-500 text-white px-6 py-2 rounded-full hover:bg-green-600 transition flex items-center mx-auto gap-2"
                        >
                            Écouter 
                        ...
                        <button 
                            ...
                            class="bg-blue-500 text-white px-6 py-2 rounded-full hover:bg-blue-600 transition flex items-center mx-auto gap-2 mt-2"
                        >
                            Prochain Verset 
...
{{-- Le script est ici directement et ne dépend plus de @push('scripts') --}}
<script>
    function speakVerse() {
        let verseReference = document.getElementById('verseReference').innerText;
        let verseText = document.getElementById('verseText').innerText;
        responsiveVoice.speak(verseReference + " : " + verseText, "French Female");
    }
</script>
